...
OPCODE_DEF(OC_POPULATION, (OCT_MVAL | OCT_EXPRLEAF))
...
OPCODE_DEF(OC_INDGET, (OCT_MVAL | OCT_EXPRLEAF))
...
OPCODE_DEF(OC_FNGVGET2, (OCT_MVAL | OCT_EXPRLEAF))
