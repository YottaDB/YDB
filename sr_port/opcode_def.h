...
OPCODE_DEF(OC_ZYDECODE, (OCT_NULL))
OPCODE_DEF(OC_ZYDECODE_GVARG, (OCT_NULL))
OPCODE_DEF(OC_ZYDECODE_LVARG, (OCT_MVADDR | OCT_MVAL | OCT_EXPRLEAF))
OPCODE_DEF(OC_INDZYDECODE, (OCT_NULL))
OPCODE_DEF(OC_INDZYDECODE2, (OCT_NULL))
OPCODE_DEF(OC_ZYENCODE, (OCT_NULL))
OPCODE_DEF(OC_ZYENCODE_GVARG, (OCT_NULL))
OPCODE_DEF(OC_ZYENCODE_LVARG, (OCT_MVADDR | OCT_MVAL | OCT_EXPRLEAF))
OPCODE_DEF(OC_INDZYENCODE, (OCT_NULL))
OPCODE_DEF(OC_INDZYENCODE2, (OCT_NULL))
