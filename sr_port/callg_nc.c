...
INTPTR_T callg_nc(callgncfnptr fnptr, gparam_list *paramlist)
{
	...
	switch(paramlist->n)
	{
		...
		case 3:
		case 4:
			return (fnptr)(VAR_ARGS4(paramlist->arg));
		case 5:
		case 6:
		case 7:
		case 8:
			return (fnptr)(VAR_ARGS8(paramlist->arg));
		case 9:
		case 10:
		case 11:
		case 12:
			return (fnptr)(VAR_ARGS12(paramlist->arg));
		case 13:
		case 14:
		case 15:
		case 16:
			return (fnptr)(VAR_ARGS16(paramlist->arg));
		case 17:
		case 18:
		case 19:
		case 20:
			return (fnptr)(VAR_ARGS20(paramlist->arg));
		case 21:
		case 22:
		case 23:
		case 24:
			return (fnptr)(VAR_ARGS24(paramlist->arg));
		case 25:
		case 26:
		case 27:
		case 28:
			return (fnptr)(VAR_ARGS28(paramlist->arg));
		case 29:
		case 30:
		case 31:
		case 32:
			return (fnptr)(VAR_ARGS32(paramlist->arg));
		case 33:
		case 34:
		case 35:
		case 36:
