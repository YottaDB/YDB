...
LITDEF	int	jnl_fixed_size[JRT_RECTYPES] =
{
...
int4	jnl_record_length(jnl_record *rec, int4 top)  /* top is maximum length of record (e.g.: end of buffer) */
{
	...
	n = JREC_PREFIX_SIZE + jnl_fixed_size[rectype];
