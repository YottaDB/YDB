...
#ifndef _GTMSOURCE_HEARTBEAT_H
#define _GTMSOURCE_HEARTBEAT_H
...
#define gtmsource_is_heartbeat_due(now) !(-1 == last_sent_time || difftime(*now, last_sent_time) < (double)jnlpool.gtmsource_local->connect_parms[GTMSOURCE_CONN_HEARTBEAT_PERIOD])
#else
