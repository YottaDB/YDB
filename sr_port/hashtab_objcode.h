...
ht_ent_objcode *lookup_hashtab_objcode(hash_table_objcode *table, icode_str *key);
...
sm_uc_ptr_t copy_hashtab_to_buffer_objcode(hash_table_objcode *table,
		sm_uc_ptr_t buffer, int (*copy_entry_to_buffer)(ht_ent_objcode *, sm_uc_ptr_t));
hash_table_objcode *activate_hashtab_in_buffer_objcode(sm_uc_ptr_t buffer,
		int (*copy_entry_from_buffer)(ht_ent_objcode *, sm_uc_ptr_t));
