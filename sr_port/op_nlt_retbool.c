...
/* Note: This C function is called by "opp_nlt_retbool.s". */
int	op_nlt_retbool(mval *u, mval *v)
{
	long	ret;
	...
	/* The below code is similar to that in "bxrelop_operator.c" (for OC_NLT case).
