...
LITDEF	err_msg merrors[] = {
	...
	{ "INVYDBEXIT", "Inappropriate invocation of ydb_exit. ydb_exit cannot be invoked from external calls.", 0 },
	...
	{ "CALLINAFTERXIT", "After a ydb_exit, a process can never create a valid YottaDB context", 0 },
