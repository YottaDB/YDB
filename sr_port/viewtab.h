...
VIEWTAB("GVFIRST", 	VTP_NULL, 		VTK_GVFIRST, 	MV_STR),
...
VIEWTAB("LVDUPCHECK",	VTP_NULL | VTP_VALUE, 	VTK_LVDUPCHECK, MV_STR),
...
VIEWTAB("YCOLLATE",	VTP_VALUE, 		VTK_YCOLLATE, 	MV_NM),
...
VIEWTAB("ZDEFSIZE",	VTP_DBREGION, 		VTK_ZDEFSIZE, 	MV_NM),
