...
/*
 * Description:
 *	This is called, if ZYENCODE parameter has any indirection.
 * Parameters:
 *	glvn_mv: the (mval*) for one of the arguments of zyencode.
 *	arg1_or_arg2: Is it left hand side or right hand side
 *		ARG1_LCL | ARG1_GBL => glvn1
 *		ARG2_LCL | ARG2_GBL => glvn2
 * Notes:
 *	Unlike op_indset which is called once for a SET, this is called twice for ZYENCODE command,
...
void op_indzyencode(mval *glvn_mv, mval *arg1_or_arg2)
{
	...
	indir_src.code = leftarg ? indir_zyencode1 : indir_zyencode2;
