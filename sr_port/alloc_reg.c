			...
			case OC_BOOLEXPRSTART:
				...
				if (NO_REF != x->operand[0].oprclass)
				{
					...
					assert((OC_EQUNUL_RETBOOL == x->operand[0].oprval.tref->opcode)
						...
						|| (OC_GT_RETBOOL == x->operand[0].oprval.tref->opcode)
						|| (OC_NGT_RETBOOL == x->operand[0].oprval.tref->opcode)
						|| (OC_LT_RETBOOL == x->operand[0].oprval.tref->opcode)
						|| (OC_NLT_RETBOOL == x->operand[0].oprval.tref->opcode));
			...
			case OC_BOOLEXPRFINISH:
				...
				if (OC_NOOP == y->opcode)
				{
					...
					assert((OC_EQUNUL_RETBOOL == y->operand[0].oprval.tref->opcode)
						...
						|| (OC_GT_RETBOOL == y->operand[0].oprval.tref->opcode)
						|| (OC_NGT_RETBOOL == y->operand[0].oprval.tref->opcode)
						|| (OC_LT_RETBOOL == y->operand[0].oprval.tref->opcode)
						|| (OC_NLT_RETBOOL == y->operand[0].oprval.tref->opcode));
