...
/* Note: This C function is called by "opp_lt_retbool.s". */
int	op_lt_retbool(mval *u, mval *v)
{
	long	ret;
	...
	/* The below code is similar to that in "bxrelop_operator.c" (for OC_LT case).
