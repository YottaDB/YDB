...
JNL_TABLE_ENTRY (JRT_PBLK,   mur_extract_pblk, "PBLK",   sizeof(fixed_jrec_pblk))		/* 10: Before-image physical journal transaction */
...
JNL_TABLE_ENTRY (JRT_AIMG,   mur_extract_aimg, "AIMG",   sizeof(fixed_jrec_after_image)) 	/* 26: After-image physical journal transaction */
