...
LITDEF char ctypetab[NUM_ASCII_CHARS] = {
...
,TK_ERROR,TK_ERROR,TK_ERROR,TK_ERROR,TK_ERROR,TK_ERROR,TK_ERROR,TK_ERROR
,TK_SPACE,TK_EXCLAIMATION,TK_QUOTE,TK_HASH
	,TK_DOLLAR,TK_PERCENT,TK_AMPERSAND,TK_APOSTROPHE
...
,TK_DIGIT,TK_DIGIT,TK_COLON,TK_SEMICOLON
	,TK_LESS,TK_EQUAL,TK_GREATER,TK_QUESTION
...
,TK_UPPER,TK_UPPER,TK_UPPER,TK_UPPER,TK_UPPER,TK_UPPER,TK_UPPER,TK_UPPER
,TK_UPPER,TK_UPPER,TK_UPPER,TK_LBRACKET
	,TK_BACKSLASH,TK_RBRACKET,TK_CIRCUMFLEX,TK_UNDERSCORE
