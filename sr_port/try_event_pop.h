...
#	ifdef NOISY					/* define or remove totrack unwinds, but notmally just distracting noise */
	DBGDFRDEVNT((stderr, "%try_event_pop oob:%d next:%d/%d\n",
		outofband, (TREF(save_xfer_root_ptr))->ev_que.fl->outofband, (TREF(save_xfer_root_ptr))->ev_que.fl->event_state));
#	endif
