...
void mupip_set(void)
{
	...
	if ((CLI_PRESENT == cli_present("ACCESS_METHOD"))
		...
		|| (CLI_PRESENT == cli_present("SEARCH_INDEX"))
		|| (CLI_NEGATED == cli_present("SEARCH_INDEX"))
		|| (CLI_PRESENT == cli_present("SEARCH_INDEX_SIZE"))
		...
		|| (CLI_PRESENT == cli_present("STATSDB_ALLOCATION"))
