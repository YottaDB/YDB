...
TAB_BG_TRC_REC("  WcBlocked nocr_invcr  ", wcb_t_end_sysops_cr1)
TAB_BG_TRC_REC("  WcBlocked cr_invcr    ", wcb_t_end_sysops_cr2)
TAB_BG_TRC_REC("  WcBlocked wait1       ", wcb_t_end_sysops_wait1)
TAB_BG_TRC_REC("  WcBlocked wait2       ", wcb_t_end_sysops_wait2)
