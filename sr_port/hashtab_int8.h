...
sm_uc_ptr_t copy_hashtab_to_buffer_int8(hash_table_int8 *table,
		sm_uc_ptr_t buffer, int (*copy_entry_to_buffer)(ht_ent_int8 *, sm_uc_ptr_t));
hash_table_int8 *activate_hashtab_in_buffer_int8(sm_uc_ptr_t buffer,
		int (*copy_entry_from_buffer)(ht_ent_int8 *, sm_uc_ptr_t));
