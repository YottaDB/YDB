...
/*
 Convert a transaction from jnl version  17 (V5) to 17  (V5)
 Currently we only need to check whether null subscripts transfromation is needed.
*/

int jnl_v17tov17(uchar_ptr_t jnl_buff, uint4 *jnl_len, uchar_ptr_t conv_buff, uint4 *conv_len, uint4 conv_bufsiz)
{
