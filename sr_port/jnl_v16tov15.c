...
/*
Convert a transaction from jnl version  16 (V5) to 15  (GT.M versions V4.4-002 through V4.4-004)
Journal format is same, only null susbcripts transfromation may be needed and need to check whether any global name length > 8
*/

int jnl_v16tov15(uchar_ptr_t jnl_buff, uint4 *jnl_len, uchar_ptr_t conv_buff, uint4 *conv_len, uint4 conv_bufsiz)
{
