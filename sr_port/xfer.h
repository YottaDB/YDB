...
XFER(xf_mval2bool, op_mval2bool),
...
XFER(xf_fnzysuffix, op_fnzysuffix),
...
XFER(xf_bool2mint, bool2mint),
XFER(xf_bool2mval, bool2mval),
XFER(xf_bool_andor, bool_andor),
XFER(xf_boolinit, bool_init),
XFER(xf_boolexprstart, bool_init),
XFER(xf_boolexprfinish, bool_finish),
XFER(xf_equnul_retmval, op_equnul_retmval),
XFER(xf_nequnul_retmval, op_nequnul_retmval),
XFER(xf_equnul_retbool, opp_equnul_retbool),
XFER(xf_nequnul_retbool, opp_nequnul_retbool),
XFER(xf_equ_retbool, opp_equ_retbool),
XFER(xf_nequ_retbool, opp_nequ_retbool),
XFER(xf_equ_retmval, op_equ_retmval),
XFER(xf_nequ_retmval, op_nequ_retmval),
XFER(xf_contain_retbool, opp_contain_retbool),
XFER(xf_ncontain_retbool, opp_ncontain_retbool),
XFER(xf_contain_retmval, op_contain_retmval),
XFER(xf_ncontain_retmval, op_ncontain_retmval),
XFER(xf_follow_retbool, opp_follow_retbool),
XFER(xf_nfollow_retbool, opp_nfollow_retbool),
XFER(xf_follow_retmval, op_follow_retmval),
XFER(xf_nfollow_retmval, op_nfollow_retmval),
XFER(xf_pattern_retbool, opp_pattern_retbool),
XFER(xf_npattern_retbool, opp_npattern_retbool),
XFER(xf_pattern_retmval, op_pattern_retmval),
XFER(xf_npattern_retmval, op_npattern_retmval),
XFER(xf_sortsafter_retbool, opp_sortsafter_retbool),
XFER(xf_nsortsafter_retbool, opp_nsortsafter_retbool),
XFER(xf_sortsafter_retmval, op_sortsafter_retmval),
XFER(xf_nsortsafter_retmval, op_nsortsafter_retmval),
XFER(xf_gt_retbool, opp_gt_retbool),
XFER(xf_ngt_retbool, opp_ngt_retbool),
XFER(xf_gt_retmval, op_gt_retmval),
XFER(xf_ngt_retmval, op_ngt_retmval),
XFER(xf_lt_retbool, opp_lt_retbool),
XFER(xf_nlt_retbool, opp_nlt_retbool),
XFER(xf_lt_retmval, op_lt_retmval),
XFER(xf_nlt_retmval, op_nlt_retmval),
XFER(xf_bxrelop_equ, opp_bxrelop_equ),
XFER(xf_bxrelop_nequ, opp_bxrelop_nequ),
XFER(xf_bxrelop_contain, opp_bxrelop_contain),
XFER(xf_bxrelop_ncontain, opp_bxrelop_ncontain),
XFER(xf_bxrelop_sortsafter, opp_bxrelop_sortsafter),
XFER(xf_bxrelop_nsortsafter, opp_bxrelop_nsortsafter),
XFER(xf_bxrelop_pattern, opp_bxrelop_pattern),
XFER(xf_bxrelop_npattern, opp_bxrelop_npattern),
XFER(xf_bxrelop_follow, opp_bxrelop_follow),
XFER(xf_bxrelop_nfollow, opp_bxrelop_nfollow),
XFER(xf_bxrelop_gt, opp_bxrelop_gt),
...
XFER(xf_gvnamenaked, op_gvnamenaked),
XFER(xf_zydecode, op_zydecode),
XFER(xf_zydecode_arg, op_zydecode_arg),
XFER(xf_indzydecode, opp_indzydecode),
XFER(xf_indzydecode2, op_indzydecode2),
XFER(xf_zyencode, op_zyencode),
XFER(xf_zyencode_arg, op_zyencode_arg),
XFER(xf_indzyencode, opp_indzyencode),
XFER(xf_indzyencode2, op_indzyencode2),
