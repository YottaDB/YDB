...
/* Table to define signal names (arranged alphabetically) used in specifying which signals will or will not be forwarded. Note
...
YDBSIGNAL("SIGALRM",	SIGALRM)	/* 14 - initially set to no-forward */
YDBSIGNAL("SIGBUS",	SIGBUS)		/* 7 */
YDBSIGNAL("SIGCHLD",	SIGCHLD)	/* 17 (deprecated name) */
YDBSIGNAL("SIGCLD",	SIGCHLD)	/* 17 (newer name) */
YDBSIGNAL("SIGCONT",	SIGCONT)	/* 18 - never forwarded - always set to no-forward */
...
YDBSIGNAL("SIGKILL",	SIGKILL)	/* 9 -  not catchable/forwardable - added for completeness */
...
YDBSIGNAL("SIGSTOP",	SIGSTOP)	/* 19 - not catchable/forwardable - added for completeness */
YDBSIGNAL("SIGSYS",	SIGSYS)		/* 31 */
YDBSIGNAL("SIGTERM",	SIGTERM)	/* 15 */
YDBSIGNAL("SIGTRAP",	SIGTRAP)	/* 5 */
YDBSIGNAL("SIGTSTP",	SIGTSTP)	/* 20 - never forwarded - always set to no-forward */
YDBSIGNAL("SIGTTIN",	SIGTTIN)	/* 21 - never forwarded - always set to no-forward */
YDBSIGNAL("SIGTTOU",	SIGTTOU)	/* 22 - never forwarded - always set to no-forward */
YDBSIGNAL("SIGURG",	SIGURG)		/* 23 */
YDBSIGNAL("SIGUSR1",	SIGUSR1)	/* 10 - initially set to no-forward */
