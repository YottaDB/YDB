...
case "[Bb]*":
		...
		if ( $HOSTOS == "HP-UX" ) then
			...
			# At that time, remove this message from comque.csh (and its associated
			...
			# optimization).
			mailx -s "non-standard C compiler options" $LOGNAME <<comque1
WARNING: For HP-UX bta compilations, we have turned off the C compiler optimization.
This message generated while you were building HP-UX GT.M version $comque_ver $comque_image.
comque1
			set comque_cc_options_default = \
