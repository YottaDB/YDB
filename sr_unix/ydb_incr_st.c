 ...
 *
 * Parms and return - same as ydb_incr_s() except for the addition of tptoken.
 */
		...
		ydb_buffer_t *ret_value)
{
	...
	retval = ydb_stm_args5(tptoken, LYDB_RTN_INCR, (uintptr_t)varname, (uintptr_t)subs_used, (uintptr_t)subsarray,
