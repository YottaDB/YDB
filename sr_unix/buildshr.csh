...
gt_ld $gt_ld_options $aix_loadmap_option ${gt_ld_option_output}$3/mumps -L$gtm_obj $gtm_obj/{gtm,mumps_clitab}.o $gt_ld_sysrtns \
		-lmumps -lstub $gt_ld_gtmrpc_library_option $gt_ld_syslibs >& $gtm_map/mumps.map
...
if ( $gt_ar_gtmrpc_name != "" ) then
	...
	gt_ld $gt_ld_options $aix_loadmap_option ${gt_ld_option_output}$3/gtm_svc -L$gtm_obj $gtm_obj/{gtm_svc,mumps_clitab}.o $gt_ld_sysrtns \
		-lmumps -lstub $gt_ld_gtmrpc_library_option $gt_ld_syslibs >& $gtm_map/gtm_svc.map
