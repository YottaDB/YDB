...
help_exit()
{
    ...
    echo ""
    echo "Example usages are (assumes latest YottaDB release is r1.36 and latest GT.M version is V7.0-005)"
    echo "  $0                          # installs latest YottaDB release (r1.36) at /usr/local/lib/yottadb/r136"
    echo "  $0 --utf8 default           # installs YottaDB release r1.36 with added support for UTF-8"
    echo "  $0 --installdir /r136 r1.36 # installs YottaDB r1.36 at /r136"
