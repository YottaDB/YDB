...
help_exit()
{
    ...
    echo "  ydbinstall.sh                          # installs latest YottaDB release (r1.28) at /usr/local/lib/yottadb/r128"
    echo "  ydbinstall.sh --utf8 default           # installs YottaDB release r1.28 with added support for UTF-8"
    echo "  ydbinstall.sh --installdir /r128 r1.28 # installs YottaDB r1.28 at /r128"
