...
static CLI_ENTRY	gtmrecv_qual[] =
{
	...
	{"CHANGELOG", 0, 0, 0, 0, 0, 0, VAL_DISALLOWED, 0, NON_NEG, VAL_N_A, 0 },
	{"CHECKHEALTH", 0, 0, 0, 0, 0, 0, VAL_DISALLOWED, 0, NON_NEG, VAL_N_A, 0 },
	{"CREAINST",  0, 0, 0, 0, 0, 0, VAL_DISALLOWED, 0, NON_NEG, VAL_N_A, 0 },
	{"FILTER", 0, 0, 0, 0, 0, 0, VAL_REQ, 0, NON_NEG, VAL_STR, 0 },
...
static	CLI_ENTRY	mup_replicate_qual[] =
{
	...
	{ "RECEIVER",           (void(*)(void))gtmrecv, gtmrecv_qual, 0, 0, 0, 0, VAL_DISALLOWED, 0, NON_NEG, VAL_N_A,  0 },
	{ "SOURCE",             (void(*)(void))gtmsource, gtmsource_qual, 0, 0, 0, 0, VAL_DISALLOWED, 0, NON_NEG, VAL_N_A,  0 },
...
GBLDEF	CLI_ENTRY	cmd_ary[] =
{
	...
	{ "FREEZE",  	mupip_freeze,      mup_freeze_qual,  	mup_freeze_parm,  	0, 0, 0, VAL_DISALLOWED, 1, 0, 0, 0 },
	{ "FTOK", 	mupip_ftok,        mup_ftok_qual,	mup_ftok_parm,		0, 0, 0, VAL_DISALLOWED, 1, 0, 0, 0 },
	{ "HELP",    	mupip_help,        0,                	0,                	0, 0, 0, VAL_DISALLOWED, 0, 0, 0, 0 },
	{ "INTEG",   	mupip_integ,       mup_integ_qual,   	mup_integ_parm,   	0, 0, 0, VAL_DISALLOWED, 1, 0, 0, 0 },
	...
	{ "REPLICATE",	0,   		   mup_replicate_qual,	mup_replicate_parm,	0, 0, 0, VAL_DISALLOWED, 1, 0, 0, 0 },
	{ "RESTORE", 	mupip_restore,     mup_restore_qual, 	mup_restore_parm, 	0, 0, 0, VAL_DISALLOWED, 2, 0, 0, 0 },
	{ "RUNDOWN", 	mupip_rundown,     mup_rundown_qual, 	mup_rundown_parm, 	0, 0, 0, VAL_DISALLOWED, 1, 0, 0, 0 },
