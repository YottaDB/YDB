 ...
 *
 * Parms and return - same as ydb_node_previous_s() except for the addition of tptoken.
 */
			 ...
			 ydb_buffer_t *ret_subsarray)
{
	...
	retval = ydb_stm_args5(tptoken, LYDB_RTN_NODE_PREVIOUS, (uintptr_t)varname, (uintptr_t)subs_used,
