...
LYDBRTN(LYDB_RTN_TP_ROLLBACK,		LYDB_SIMPLEAPI,		"ydb_tp_s()"),			/* Not needed but there as a counterpart for LYDB_RTN_TP_ROLLBACK_TLVL0 */
...
LYDBRTN(LYDB_RTN_TP_ROLLBACK_TLVL0,	LYDB_SIMPLEAPI,		"ydb_tp_s()"),			/* "ydb_tp_s" to do "op_trollback" in SimpleThreadAPI for outermost TP */
