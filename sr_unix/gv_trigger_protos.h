...
STATICFNDCL 	void		gvtr_db_tpwrap(sgmnt_addrs *csa, boolean_t tp_is_implicit);
STATICFNDCL	void		gvtr_db_tpwrap_helper(sgmnt_addrs *csa, boolean_t tp_is_implicit);
STATICFNDCL	boolean_t	gvtr_get_hasht_gblsubs(mval *subs_mval, mval *ret_mval);
STATICFNDCL	void		gvtr_process_range(gv_namehead *gvt, gvtr_subs_t *subsdsc, int type, char *start, char *end);
...
STATICFNDCL	void		gvtr_sort_sets_first(gvt_trigger_t *gvt_trigger, gv_trigger_t *trigtop);
STATICFNDCL	void		gvtr_db_read_hasht(sgmnt_addrs *csa);
...
STATICFNDCL	void		gvtr_free(gv_namehead *gvt);
