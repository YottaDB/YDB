 ...
 *
 * Parms and return - same as ydb_data_s() except for the addition of tptoken and errstr.
 */
			...
			unsigned int *ret_value)
{
	...
	retval = ydb_stm_args4(tptoken, errstr, LYDB_RTN_DATA, (uintptr_t)varname, (uintptr_t)subs_used, (uintptr_t)subsarray,
			       (uintptr_t)ret_value);
	return (int)retval;
}
