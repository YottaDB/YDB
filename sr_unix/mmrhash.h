...
inline void	ydb_mmrhash_32(const void *key, int len, uint4 seed, uint4 *out4);

/* Returns a 128-bit (16-byte) endian-independent murmur hash */
inline void	ydb_mmrhash_128(const void *key, int len, uint4 seed, ydb_uint16 *out);
...
inline void	ydb_mmrhash_128_hex(const ydb_uint16 *hash, unsigned char *out);

/* The below function converts the 16-byte hash stored in a "ydb_uint16" structure (2 8-byte integers)
 * into a byte array "out" of 16 characters. It is also internally used by "ydb_mmrhash_128_hex()".
 */
inline void	ydb_mmrhash_128_bytes(const ydb_uint16 *hash, unsigned char *out);
...
inline void ydb_mmrhash_32(const void *key, int len, uint4 seed, uint4 *out4)
{
	...
	ydb_mmrhash_128(key, len, seed, &out16);
