...
# This is an assembly implementation of "sr_port/op_nequnul_retbool.c".
# Done currently only on x86_64 for performance reasons (on aarch64 and armv7l,
# opp_nequnul_retbool.s simply calls into op_nequnul_retbool.c).

# This file is almost the same as sr_x86_64/op_equnul_retbool.s except for flipping/inverting the return value.
# Kept separately inspite of the code duplication for performance reasons.
...
ENTRY	opp_nequnul_retbool
	...
	jne	nullstr					# If yes, then treat it as equal to the null string
