...
L67:	movb	$mval_esign_mask,mval_b_exp(REG64_ARG1)
	negl	REG32_ACCUM
	jmp	L69
...
ccmp:	#movq	REG64_ARG1,REG64_SCRATCH1	# Exchange argument registers before fun call
	#movq	REG64_ARG0,REG64_ARG1
	#movq	REG64_SCRATCH1,REG64_ARG0
...
l63:	popq    REG_XFER_TABLE
	...
	movl	$MPR_OUTOFFOR,REG32_ARG0
	call	pcurrpos			# to count fors properly
	ret

d:	movl	$MPR_INTOFOR,REG32_ARG0
	call	pcurrpos
	popq    REG_XFER_TABLE
	leave
	addq    $24,REG_SP
