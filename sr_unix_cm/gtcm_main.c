...
#ifndef lint
static char rcsid[] = "$Header: /cvsroot/sanchez-gtm/gtm/sr_unix_cm/gtcm_main.c,v 1.1.1.1 2001/05/16 14:01:54 marcinim Exp $";
#endif
...
GBLDEF int4		 omi_nxact2  = 0;  /* transactions since last stat
					      dump */
