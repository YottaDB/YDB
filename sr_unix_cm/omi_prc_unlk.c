...
#ifndef lint
static char rcsid[] = "$Header: /cvsroot/sanchez-gtm/gtm/sr_unix_cm/omi_prc_unlk.c,v 1.1.1.1 2001/05/16 14:01:54 marcinim Exp $";
#endif
...
int
omi_prc_unlk(omi_conn *cptr, char *xend, char *buff, char *bend)
{
    GBLREF int		 omi_pid;
...
/*  Bounds checking */
    ...
    {	assert(mlk_pvt_root->nodptr->auxowner = (int4) cptr);
