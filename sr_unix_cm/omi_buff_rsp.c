...
#ifndef lint
static char rcsid[] = "$Header: /cvsroot/sanchez-gtm/gtm/sr_unix_cm/omi_buff_rsp.c,v 1.1.1.1 2001/05/16 14:01:54 marcinim Exp $";
#endif
...
int
omi_buff_rsp(rhptr, ehptr, status, bptr, len)
    omi_req_hdr	*rhptr;
    omi_err_hdr	*ehptr;
    omi_status	 status;
    char	*bptr;
