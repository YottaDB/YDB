...
# opp_contain_retbool.s
#	Convert mval to bool.
# args:
#	See op_contain_retbool.c for input args details
#

	.title	opp_contain_retbool.s

	.include "linkage.si"
	.include "mval_def.si"
#	include "debug.si"

	.sbttl	opp_contain_retbool
...
ENTRY opp_contain_retbool
	...
	bl	op_contain_retbool
				/* Call C function `op_contain_retbool` with the same parameters that we were passed in with.
